...
- Avoid port conflicts between lessons. Check existing examples before choosing new host ports. Current lesson-owned host ports include `3001`, `4101`, `4102`, `8088`, `8443`, `27031` for `03-be-db-app` MongoDB, `27041`-`27043` for `04-replicaset` MongoDB, and `27050`-`27053` for `05-sharding` MongoDB.
