...
- Avoid port conflicts between lessons. Check existing examples before choosing new host ports. Current lesson-owned host ports include `3001`, `4101`, `4102`, `8088`, `8443`, `3013` plus `27031` for `03-be-db-app`, `27041`-`27043` for `04-replicaset` MongoDB, `27050`-`27053` for `05-sharding` MongoDB, `3017` plus `6371`-`6376` for `07-caching` Redis, and `3018` for `08-eda`.
