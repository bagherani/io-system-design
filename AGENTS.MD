...
- Avoid port conflicts between lessons. Check existing examples before choosing new host ports. Current lesson-owned host ports include `3001`, `3013`, `3014`, `3015`, `3016`, `3017`, `3018`, `3019`, `4101`, `4102`, `8088`, and `8443`; `3019` is owned by `01-rate-limiting`; MongoDB ports include `27031` for `03-be-db-app`, `27041`-`27043` for `04-replicaset`, and `27050`-`27053` for `05-sharding`; Redis ports include `6371`-`6376` for `07-caching`; and `01-grpc` also reserves service port `5001` for local gRPC traffic.
